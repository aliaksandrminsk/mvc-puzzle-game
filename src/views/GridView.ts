...
//     0,
//     0,
//     this.grid.width * Settings.Blocks.SizePixels.x,
//     this.grid.height * Settings.Blocks.SizePixels.y,
//     15
//   );
...
//   var pos: Vec2 = Vec2.sum(
//     Settings.Blocks.PivotPixels,
//     Vec2.product(block.gridPos, Settings.Blocks.SizePixels)
//   );
